...
const RentalPostSchema: Schema = new Schema(
  {
    ...
    postPackage: {
      packageName: { type: String, enum: ['Tin thường', 'VIP1', 'VIP2', 'VIP3'], required: true },
    ...
    autoBoost: {
      ...
      nextBoostAt: { type: Date }
    },
    views: { type: Number, default: 0 },
    favoritesCount: { type: Number, default: 0 },
    author: { type: Schema.Types.ObjectId, ref: 'RentalAuthorModel', required: true },
    expiredAt: { type: Date },
